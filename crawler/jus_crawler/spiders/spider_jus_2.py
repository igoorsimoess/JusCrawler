        ...
        def extract_movimentacoes(html):
            ...
            for tr in response.css('#tabelaUltimasMovimentacoes'):
                data_movimentacao = tr.css(
                    'tr.fundoClaro.movimentacaoProcesso .dataMovimentacaoProcesso::text').get().strip()
                descricao_movimentacao = tr.css(
                    'tr.fundoClaro.movimentacaoProcesso .descricaoMovimentacaoProcesso::text').get().strip()
